...
exports.shouldUseRouteDraftWorkflow = shouldUseRouteDraftWorkflow;
exports.buildRouteDraftRequest = buildRouteDraftRequest;
...
function shouldUseRouteDraftWorkflow(message) {
...
function buildRouteDraftRequest(message) {
